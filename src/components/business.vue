      ...
      <div class="total_evaluate clear">
        ...
        <div class="detail_code">
          <p>
            ...
            <YellowStar :code="business_info.service_code"></YellowStar>
            <span class="orange_code  v-md">{{ business_info.service_code }}</span>
          </p>
          <p>
            <span class="small_tit v-md">菜品评价</span>
            <YellowStar :code="business_info.foods_code"></YellowStar>
...
export default {
  ...
  methods: {
    ...
    rightControlLeftClass () {
      ...
      var asIndex = 0;
      //滚动事件监听
      rightUl.addEventListener('scroll', function() {
        // 当前scrollTop
    ...
    leftControlRightScroll (index) {
       ...
       */
       ...
       leftLI[index].classList.add('active_ia')
...
.flyball .inner {
    -webkit-transition:-webkit-transform .5s cubic-bezier(1,-.25,1,1);
    transition:-webkit-transform .5s cubic-bezier(1,-.25,1,1);
    transition:transform .5s cubic-bezier(1,-.25,1,1);
    transition:transform .5s cubic-bezier(1,-.25,1,1), -webkit-transform .5s cubic-bezier(1,-.25,1,1);
}
